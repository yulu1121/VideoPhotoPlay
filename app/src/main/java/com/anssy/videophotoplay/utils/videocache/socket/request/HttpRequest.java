package com.anssy.videophotoplay.utils.videocache.socket.request;

import com.anssy.videophotoplay.utils.videocache.common.VideoCacheException;
import com.anssy.videophotoplay.utils.videocache.socket.request.Method;
...
public class HttpRequest {
    ...
    private com.anssy.videophotoplay.utils.videocache.socket.request.Method mMethod;
    private String mUri;
    ...
    public void parseRequest() throws Exception {
        ...
        mMethod = com.anssy.videophotoplay.utils.videocache.socket.request.Method.lookup(extraInfo.get("method"));
        if (mMethod == null) {
