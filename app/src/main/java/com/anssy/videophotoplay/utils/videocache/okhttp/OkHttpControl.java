...
import com.anssy.videophotoplay.utils.videocache.okhttp.OkHttpUtils;
...
public class OkHttpControl {
    ...
    public OkHttpControl(String url, Map<String, String> headers, boolean isHeadRequest, @NonNull IHttpPipelineListener listener, @NonNull NetworkConfig config) {
        ...
        mOkHttpClient = com.anssy.videophotoplay.utils.videocache.okhttp.OkHttpUtils.createOkHttpClient(url, mReadTimeout, mConnTimeout, mIgnoreCert, mHttpPipelineListener);
        mRequestBuilder = com.anssy.videophotoplay.utils.videocache.okhttp.OkHttpUtils.createRequestBuilder(url, mHeaders, mIsHeadRequest);
    }
    ...
    public void markRequest() throws IOException {
        ...
        if (shouldRedirect()) {
            ...
            //mUrl已经发生了变化了
            mOkHttpClient = com.anssy.videophotoplay.utils.videocache.okhttp.OkHttpUtils.createOkHttpClient(mUrl, mReadTimeout, mConnTimeout, mIgnoreCert, mHttpPipelineListener);
