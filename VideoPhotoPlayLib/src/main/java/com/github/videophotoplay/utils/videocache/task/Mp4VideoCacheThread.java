package com.github.videophotoplay.utils.videocache.task;

import com.github.videophotoplay.utils.videocache.common.VideoCacheException;
import com.github.videophotoplay.utils.videocache.listener.IMp4CacheThreadListener;
import com.github.videophotoplay.utils.videocache.model.VideoRange;
...
public class Mp4VideoCacheThread implements Runnable {
    ...
    public boolean isPositionContained(long position) {
        return mRequestRange != null && mRequestRange.contains(position);
    }
    ...
    private void downloadVideoByOkHttp() {
        ...
        try {
            ...
            inputStream = OkHttpManager.getInstance().getResponseBody(mVideoUrl, mHeaders, contentLength -> {
                LogUtils.i(TAG, "getResponse2Body--->FetchContentLength: " + contentLength);
            });
