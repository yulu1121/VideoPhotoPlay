package com.github.videophotoplay.utils.videocache.utils;
...
import com.github.videophotoplay.utils.videocache.common.VideoMime;
...
public class ProxyCacheUtils {
    ...
    public static String encodeUriWithBase64(String str) {
        try {
            return Base64.encodeToString(str.getBytes(StandardCharsets.UTF_8), Base64.NO_WRAP | Base64.NO_PADDING);
        } catch (Exception e) {
            return str;
        }
    }
