package com.github.videophotoplay.utils.videocache;
...
import com.github.videophotoplay.utils.videocache.common.ProxyMessage;
import com.github.videophotoplay.utils.videocache.common.VideoCacheConfig;
import com.github.videophotoplay.utils.videocache.common.VideoCacheException;
import com.github.videophotoplay.utils.videocache.common.VideoType;
import com.github.videophotoplay.utils.videocache.listener.IVideoCacheListener;
import com.github.videophotoplay.utils.videocache.listener.IVideoCacheTaskListener;
import com.github.videophotoplay.utils.videocache.listener.IVideoInfoParsedListener;
import com.github.videophotoplay.utils.videocache.listener.VideoInfoParsedListener;
...
import com.github.videophotoplay.utils.videocache.okhttp.IHttpPipelineListener;
import com.github.videophotoplay.utils.videocache.okhttp.NetworkConfig;
import com.github.videophotoplay.utils.videocache.okhttp.OkHttpManager;
import com.github.videophotoplay.utils.videocache.proxy.LocalProxyVideoServer;
import com.github.videophotoplay.utils.videocache.task.M3U8CacheTask;
import com.github.videophotoplay.utils.videocache.task.Mp4CacheTask;
import com.github.videophotoplay.utils.videocache.task.VideoCacheTask;
import com.github.videophotoplay.utils.videocache.utils.LogUtils;
import com.github.videophotoplay.utils.videocache.utils.ProxyCacheUtils;
import com.github.videophotoplay.utils.videocache.utils.StorageUtils;
import com.github.videophotoplay.utils.videocache.utils.VideoProxyThreadUtils;
...
public class VideoProxyCacheManager {
            ...
            if (cacheListener != null) {
                switch (msg.what) {
                    ...
                    case ProxyMessage.MSG_VIDEO_PROXY_COMPLETED:
                        ...
                        VideoCacheTask videoCacheTask = mCacheTaskMap.get(cacheInfo.getVideoUrl());
                        if (null!=videoCacheTask){
                            videoCacheTask.setCompleted(true);
                        }
                        break;
                    default:
                        break;
    ...
    public boolean isTaskPause(String url){
        VideoCacheTask cacheTask = mCacheTaskMap.get(url);
        if (cacheTask!=null){
            return cacheTask.isPaused;
        }
        return false;
    }

    public boolean isTaskComplete(String url){
        VideoCacheTask cacheTask = mCacheTaskMap.get(url);
        if (cacheTask!=null){
            return cacheTask.isCompleted;
        }
        return false;
    }
